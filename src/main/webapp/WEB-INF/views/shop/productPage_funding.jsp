...
<head>
	...
	<link rel="stylesheet" href="../../../assets/css/shop/productPage_funding.css">
</head>
				...
				<div class="product-section">
					...
					<div class="order-section">
						...
						<div class="funding-box">
							<div class="funding-box-font">[단독]하겐다즈 프리미엄 수제 아이스크림 케이크 리얼블랙 (바닐라+벨지안 초코)</div>
							<div class="funding-box-font2">옵션: 바닐라</div>
							<div class="funding-controll">
								<button class="quantity-btn">-</button>
								<div class="funding-five">5%</div>
								<button class="quantity-btn">+</button>
							</div>
						</div>

						<div class="total-order" style="background: white; padding: 10px; border-radius: 4px; margin-bottom: 15px; font-size: 12px; color: #666;">
							[단독]하겐다즈 프리미엄 수제 아이스크림 케이크 <br>리얼블랙 (바닐라+벨지안 초코) <br> 바닐라 x 1 <br> 5% x 2
						</div>

						<div class="total-price">총 결제 금액 : 0000원</div>

						<button class="cart-btn">펀딩하러 가기</button>
