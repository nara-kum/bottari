									...
									<div class="product-options">
										...
										<div class="delivery-info">
											...
											<c:choose>
												...
												<c:otherwise>배송비 
													<fmt:formatNumber value="${fundingProductDetailMap.productViewVO.shipping_cost}" pattern="#,###" />원
												</c:otherwise>
											</c:choose>
										</div>
										<div class="delivery-info">
											<span class="icon">📍</span> 
											배송지: ${fundingProductDetailMap.productViewVO.address}
						...
						<div class="order-section">
							...
							<c:choose>
								...
								<c:otherwise>
									...
									<form action="/payment/checkout_funding?funding_no=${fundingProductDetailMap.fundingProductVO.funding_no}&count=${quantity}"  method="get">
										...
										<button class="funding-btn" type="submit">펀딩하러가기</button>
									</form>
