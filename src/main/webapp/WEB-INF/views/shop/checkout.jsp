						...
						<div id="sec-content" class="sector">
							...
							<div class="sec-content-main">
								<div class="left-main content-height">
									...
									<div class="column-flex-box">
										<div class="row-flex-box gap-10 ">
											<input class="input-commonness text-16" type="text" id="zipcode"
												placeholder="우편번호">
											<button class="input-commonness btn-basic regular"
												onclick="exeDaumPostcode()">우편번호 찾기</button>
										</div>
										<div class="row-flex-box gap-10">
											<input class="input-commonness address-box" type="text" id="address"
												placeholder="주소">
											<input class="input-commonness address-box" type="text" id="detailAddress"
												placeholder="상세주소">
										</div>
									</div>
								</div>
								<div class="right-main content-height">
									...
									<button type="button" id="paymentButton"
										class="margin-top-10 btn-basic btn-orange size-large text-16 right-align">
										<fmt:formatNumber value="${total_amount + shipping_cost}" type="currency"
											currencySymbol="" />
										원 결제하기
									</button>
								</div>
