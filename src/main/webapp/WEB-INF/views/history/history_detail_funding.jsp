            ...
            <c:forEach items="${requestScope.hList}" var="vo">
                ...
                <div class="list-basic list-1200 column-flex-box detail">
                    ...
                    <div class="between-flex-box">
                        <div class="text-14">상품금액(${requestScope.pList.percent * requestScope.hList.quantity}%)</div>
                        <div class="text-14"><fmt:formatNumber value="${requestScope.hList.total_price}" type="currency" currencySymbol="" />원</div>
                    </div>
                    <div class="btween-flex-box">
                    	<div class="text-14">펀딩정보</div>
                    </div>
                    <div class="btween-flex-box">
                    	<div class="text-14">펀딩진행상황</div>
                    	<div class="" style="width: ${requestScope.pList.quantity * requestScope.pList.percent}"></div>
                    </div>
                    <div class="between-flex-box">
                        <div class="text-14">총 결제 금액</div>
                        <div class="text-14"><fmt:formatNumber value="${requestScope.hList.total_amount}" type="currency" currencySymbol="" />원</div>
                    </div>
                </div>
                <div class="list-basic list-1200 column-flex-box detail">
                	<div class="between-flex-box box-line">
