    ...
    <content class="controller">
        <div id="sec-content" class="sector">
            ...
            <c:forEach items="${requestScope.hList}" var="vo">
                ...
                <div class="list-basic list-1200 column-flex-box detail">
                	<div class="between-flex-box box-line">
                		<div class="text-16 bold">펀딩정보</div>
                	...
                	<div class="between-flex-box">
                		...
                		<div class="bar-box row-flex-box align-center gap-10">
	                		<div class="funding-bar">
	                			<div class="activated-funding-bar" style="width: ${total_percent}%"></div>
	                		</div>
	                		<div class="text-12">${total_percent}% 진행됨</div>
                		</div>
                	</div>
                </div>
                <div class="list-basic list-1200 column-flex-box detail">
                    ...
                    <div class="text-12">구매하신 배송상품의 취소/환불 또는 교환/반품을 원하실 경우에는 다음 내용을 참고해 주세요.<br><br>
                        > 물품 배송 전 청약 철회 (취소/환불)상품(재화)을 판매자가 배송하기 이전에는 취소 및 환불 가능유효기간 이내에 배송지를 입력하지 않을 경우 자동 취소/환불 절차 진행*<br>
                        청약 철회 방법 <br>선물하기 > 선물함 > 주문내역의 해당 주문 상세화면에서 취소/환불 선택
                        > 물품 배송 후 청약 철회 (교환/반품 환불)상품(재화)의 공급을 받은 날로부터 7일 이내 청약 철회 가능* <br><br>
                        청약 철회를 할 수 없는 경우 <br>
                        소비자의 책임으로 상품(재화)이 멸실 또는 훼손된 경우소비자의 사용 또는 일부 소비에 의해 상품(재화)의 가치가 감소한 경우 <br>
                        시간의 경과에 의하여 재판매가 곤란한 경우청약 철회 등으로 제 3자에게 중대한 피해가 예상되어 사전에 고지한 경우*<br>
                        청약 철회 방법 <br>
                        선물하기 > 선물함 > 주문내역의 해당 주문 상세화면에서 반품/교환 선택수신자가 교환을 신청한 경우 관련 안내는 수신자만 받을 수 있습니다.*<br><br>
                        청약 철회 비용 부담 안내구매 철회 시 상품 회수 후 3영업일 이내에 환불 조치당사 과실로 인한 반품 교환 비용은 당사 부담고객 변심 또는 동종 상품의 사이즈나 색상 교환 시 <br>
                        비용은 고객 부담반품 / 교환비 안내 : 상품상세 > 교환/반품/환불 안내 영역에서 확인* 청약 철회서 양식주문자 계정 :주문일자 :철회일자 :상품명 :금액 :철회사유 :<br>
                        > 환불 금액 안내환불은 실제 결제한 금액으로 구매자에게 진행되며, 이로 인해 결제 취소/환불 신청 시 안내된 금액과 다를 수 있습니다.> <br><br>
                        환불지연 배상금 안내<br>
                        환불지연이 발생하였을 경우 전자상거래법에 따라 환불지연배상금 지급을 요청하실 수 있습니다.* <br>
                        환불지연에 해당하는 경우카카오의 책임으로 상품공급이 불가한 상태로 결제일로부터 3영업일이 경과한 경우<br>
                        반품 상품을 수령한 날로부터 3영업일이 경과하도록 상품대금을 환불하지 않은 경우<br>
                        > 소비자 피해보상, 재화 등에 대한 불만 및 소비자와 사업자간 분쟁 처리에 관한 사항소비자 불만 신청 : <br>
                        보따리 고객센터 (전화번호)- 상담가능시간 : 평일 09:00 ~18:00 (※ 점심시간 12:00 ~ 13:00)<br>
                        소비자 피해 분쟁 조정의 요청: 공정거래위원회 및 공정거래위원회가 지정한 분쟁 조정 기구<br>
