                            ...
                            <div class="sec-content-main">
                                ...
                                <div class="list-basic list-1200 column-flex-box detail">
                                    ...
                                    <div class="text-12">구매하신 배송상품의 취소/환불 또는 교환/반품을 원하실 경우에는 다음 내용을 참고해 주세요.<br><br>
                                        ...
                                        청약 철회 방법 <br>
                                        선물하기 > 선물함 > 주문내역의 해당 주문 상세화면에서 반품/교환 선택수신자가 교환을 신청한 경우 관련 안내는 수신자만 받을 수
                                        있습니다.*<br><br>
                                        청약 철회 비용 부담 안내구매 철회 시 상품 회수 후 3영업일 이내에 환불 조치당사 과실로 인한 반품 교환 비용은 당사 부담고객 변심 또는 동종
                                        상품의 사이즈나 색상 교환 시 <br>
                                        비용은 고객 부담반품 / 교환비 안내 : 상품상세 > 교환/반품/환불 안내 영역에서 확인* 청약 철회서 양식주문자 계정 :주문일자 :철회일자
                                        :상품명 :금액 :철회사유 :<br>
                                        > 환불 금액 안내환불은 실제 결제한 금액으로 구매자에게 진행되며, 이로 인해 결제 취소/환불 신청 시 안내된 금액과 다를 수 있습니다.>
                                        <br><br>
                                        환불지연 배상금 안내<br>
