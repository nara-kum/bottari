			...
			<div class="sec-content-main">
				<main class="signup-container">
					...
					<form class="signup-form" action="${pageContext.request.contextPath}/user/edit" method="get">
						...
						<div class="form-group">
							<label>전화번호</label>
							<input type="txt-tel" name="phone" value="${requestScope.userVO.phone}">
						</div>
											
						<div class="form-group email-group">
							<label>이메일 주소</label>
							<div class="email-inputs">
								<input type="text" placeholder="이메일 주소" name="email" value="${requestScope.userVO.email}">
								<span>@</span>
								<select>
